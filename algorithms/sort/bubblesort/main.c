...
int main(void) {
    bubblesort(unsorted0, sizeof(unsorted0)/sizeof(unsorted0[0]));
    bubblesort(unsorted1, sizeof(unsorted1)/sizeof(unsorted1[0]));
    bubblesort(unsorted2, sizeof(unsorted2)/sizeof(unsorted2[0]));
    bubblesort(unsorted3, sizeof(unsorted3)/sizeof(unsorted3[0]));
    bubblesort(unsorted4, sizeof(unsorted4)/sizeof(unsorted4[0]));
