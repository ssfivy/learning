...
int main(void) {
    insertionsort(unsorted0, sizeof(unsorted0)/sizeof(unsorted0[0]));
    insertionsort(unsorted1, sizeof(unsorted1)/sizeof(unsorted1[0]));
    insertionsort(unsorted2, sizeof(unsorted2)/sizeof(unsorted2[0]));
    insertionsort(unsorted3, sizeof(unsorted3)/sizeof(unsorted3[0]));
    insertionsort(unsorted4, sizeof(unsorted4)/sizeof(unsorted4[0]));
